...
public class EditAccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Account a = daoA.getAccountByID(id_raw);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (String e : listEmail) {
            if (e.equals(email) && !email.equals(a.getEmail())) {
                String err = "Email is existed";
                request.setAttribute("err", err);
                request.setAttribute("a", dao.getAccountByID(id));
                request.getRequestDispatcher("EditAccount.jsp").forward(request, response);
                return;
            }
        }

        dao.update(id, name, phone, address, password, email, role);
        request.setAttribute("a", dao.getAccountByID(id));
